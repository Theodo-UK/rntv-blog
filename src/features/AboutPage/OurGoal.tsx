    ...
    <div className="divide-y-4 divide-gray-200 dark:divide-gray-700">
      ...
      <div className="space-y-2 pb-8 pt-6 md:space-y-5">
        ...
        <p>
          ...
          can not only find comprehensive resources and guidance but also feel like they are part of
          a community dedicated to learning and growing in this unique space.
        </p>
      </div>
    </div>
  )
